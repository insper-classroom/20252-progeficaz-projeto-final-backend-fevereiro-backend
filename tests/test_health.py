...
def test_detailed_health_endpoint_success(client, monkeypatch):
...
def test_detailed_health_endpoint_failure(client, monkeypatch):
...
def test_health_endpoint_method_not_allowed(client):
    ...
    response_health = client.post('/health/')
    ...
    response_detailed = client.post('/health/detailed')
